    ...
    return (
      <div className="createModalContent">
        <div className="avant-wrap">
          ...
          <div className="upload-desc" style={{ color: colorTextTertiary }}>
            上传图片格式JPG/PNG
          </div>
        </div>
    ...
    return (
      <div className="addGroupWrap">
        <div className="groupLogo-wrap">
          <div className="group-logo-img">
            <Avatar src={searchGroupData?.imageUrl} />
          </div>
          <div className="groupLogo-title" style={{ color: colorPrimary }}>
            {searchGroupData?.groupName}
          </div>
        </div>

        <div className="group-content">
          <Descriptions column={2}>
            <Descriptions.Item label="团队创建者">
              {searchGroupData?.createUserName}
            </Descriptions.Item>
            <Descriptions.Item label="团队成员数">
              {searchGroupData?.memberCount}
            </Descriptions.Item>
            <Descriptions.Item label="团队描述">
              {searchGroupData?.memo}
            </Descriptions.Item>
            <Descriptions.Item label="团队创建时间">
              {dayjs(searchGroupData?.createTime).format("YYYY年MM月DD日")}
            </Descriptions.Item>
          </Descriptions>
        </div>
      </div>
    ...
    return (
      <div>
        ...
        <div className="addGroupBtn">
          <Button type="primary" onClick={onSearchGroup} loading={loading}>
            搜索
          </Button>
        </div>
      </div>
  ...
  return (
    <div className="newHome-wrap">
      <div className="newHome-left-wrap">
        <div className="newHome-title DingDing" style={{ color: colorPrimary }}>
          Welcome
        </div>
        <div
          className="newHome-desc DingDing"
          style={{ color: colorTextSecondary }}
        >
          欢迎使用财政管理系统,您可以在这里详细查看您团队或个人的财政信息、分析数据等。
        </div>
        <div
          className="newHome-desc DingDing"
          style={{ color: colorTextSecondary }}
        ...
        <div className="newHome-btn-wrap">
          <div ref={ref1} onClick={showCreateModal}>
