    ...
    <div className="guide-content-wrap">
      <div className="guide-step-icon">
        <svg
          className="icon"
          aria-hidden="true"
          style={{ color: colorTextSecondary, fontSize: 38 }}
        >
          <use xlinkHref="#icon-shenfenleibie"></use>
        </svg>
      </div>
      <div className="content-title" style={{ color: colorText }}>
        您是学生 OR 职场人 ?{" "}
      </div>
      <div
      ...
      >
        系统将根据您的身份信息向您提供行业建议、专业分析、就业形势等基础信息服务。
      </div>
        ...
        >
          <div className="item-icon">
            <svg
              className="icon"
              aria-hidden="true"
              style={{ color: colorTextSecondary, fontSize: 28 }}
            >
              <use xlinkHref="#icon-xuesheng"></use>
            </svg>
          </div>
          <div className="item-title" style={{ color: colorText }}>
            学生党
          </div>
        </div>
        <div
        ...
        >
          <div className="item-icon">
            <svg
              ...
              style={{ color: colorTextSecondary, fontSize: 38 }}
            >
              <use xlinkHref="#icon-gongwenbao"></use>
            </svg>
          </div>
          <div className="item-title" style={{ color: colorText }}>
            打工人
      ...
      <div className="footer" style={{ color: colorTextTertiary }}>
        您的个人信息是保密的,我们不会泄露您的个人信息,仅引用于个性化推荐等基础服务
      </div>
    </div>
  );
}
