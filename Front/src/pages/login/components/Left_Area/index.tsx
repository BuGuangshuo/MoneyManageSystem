        ...
        <div className = {styles['introduce-wrap']}>
            ...
            <div className={styles['introduce-text-wrap']}>
              <div className={styles['introduce-text-context']}>
                ...
                <div className={styles['introduce-desc']}>将模糊的数据转化为图表，把数据以可视化的方式呈现给您，更加直观的观察您的财政状态。</div>
              </div>
            </div>
          </div> 
          ...
          <div className = {styles['introduce-wrap']}>
            ...
            <div className={styles['introduce-text-wrap']}>
              <div className={styles['introduce-text-context']}>
                ...
                <div className={styles['introduce-desc']}>在家庭中观察更加直观的数据与您爱的人共同分享，携手共进。</div>
              </div>
            </div>
          </div> 
          ...
          <div className = {styles['introduce-wrap']}>
            ...
            <div className={styles['introduce-text-wrap']}>
              <div className={styles['introduce-text-context']}>
                ...
                <div className={styles['introduce-desc']}>将团队的财政数据化后尽情的放飞自由，让团队实现财富管理自由。</div>
              </div>
            </div>
          </div>
      </Carousel>
